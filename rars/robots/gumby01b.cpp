...
//
// Race: 28. May 1998 BORS Races (Indy500 & Pocono)
//
...
static double distancetopass(double vnow, double vthen, double radius)
{
  if (vnow<vthen)
    ...
    return (CORN_AGG * (vnow+vthen) * (vnow-vthen));
...
con_vec Gumby(situation &s)
{
	const char name[] = "Gumby";
